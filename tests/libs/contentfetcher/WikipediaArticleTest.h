...
#ifndef WIKIPEDIAARTICLETEST_H
#define WIKIPEDIAARTICLETEST_H
...
/**
 * Test for WikipediaArticle.
 *
 * @see WikipediaArticle
 * @author Tanguy Krotoff
 */
class WikipediaArticleTest : public QObject {
	Q_OBJECT
private slots:
